...
<div class="group-item">
    ...
    <button type="button" onclick="location.href='/Manage/groupinfo/<?=$group['_gid']?>'">
    변경하기
    </button>
</div>
...
<div class="request-box">
    ...
    <div class="request-item">
        ...
        <button type="button" onclick="location.href='/Manage/approval/<?=$group['mtName']?>/<?=$request['_rid']?>'">
        변경하기
        </button>
    </div>
    <?php endforeach;?>
